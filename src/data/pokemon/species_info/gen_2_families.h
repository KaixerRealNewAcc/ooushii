...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_BATTLE_ARMOR, ABILITY_SHEER_FORCE },
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_BATTLE_ARMOR, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_TECHNICIAN, ABILITY_SKILL_LINK },
